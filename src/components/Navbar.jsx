      ...
      <div className="flex items-center space-x-4">
        ...
        <div className="flex items-center space-x-1 cursor-pointer">
          <img
            ...
            className="h-5"
          />
          <span className="text-[10px] text-gray-400 -mt-2">IN</span>
        </div>
      </div>

      {/* Middle Section (Search Bar) */}
      <div className="flex items-center w-[500px] max-w-xl">
        {/* Input Box */}
        ...
        {/* Search Button */}
        <button className="bg-[#222222] border border-[#303030] rounded-r-full px-5 py-2 flex items-center justify-center hover:bg-[#303030]">
          <FiSearch className="w-5 h-5 text-gray-300" />
        </button>

        {/* Mic Button */}
        <button className="ml-3 bg-[#181818] p-2 rounded-full hover:bg-[#303030] transition">
          <FiMic className="w-5 h-5 text-white" />
        </button>
      </div>

      {/* Right Section */}
      <div className="flex items-center bg space-x-5 text-white">
        <button className="flex items-center space-x-1 bg-[#3F3F3F] hover:bg-[#857c7c] px-3 py-1 rounded-full">
